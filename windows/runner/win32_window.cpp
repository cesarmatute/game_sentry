...
Win32Window::MessageHandler(HWND hwnd,
  ...
  switch (message) {
    ...
    case WM_GETMINMAXINFO: {
      ...
      int max_height = monitorInfo.rcWork.bottom - monitorInfo.rcWork.top;
      int max_width = static_cast<int>(max_height * aspect_ratio);
      ...
      minMaxInfo->ptMaxPosition.x = (screen_width - max_width) / 2;
    ...
    case WM_SIZING: {
      ...
      // Adjust the rectangle based on the sizing edge.
      switch (wparam) {
        case WMSZ_LEFT:
